...
export function RechnungenDialog({ open, onClose, onSubmit, defaultValues, projekteList, leistungskatalogList, enablePhotoScan = true, enablePhotoLocation = true }: RechnungenDialogProps) {
