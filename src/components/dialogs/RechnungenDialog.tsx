...
interface RechnungenDialogProps {
  ...
  defaultValues?: Rechnungen['fields'];
...
export function RechnungenDialog({ open, onClose, onSubmit, defaultValues, projekteList, leistungskatalogList, enablePhotoScan = false, enablePhotoLocation = true }: RechnungenDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'rechnungen');
  ...
  const DIALOG_INTENT = defaultValues ? 'Rechnungen bearbeiten' : 'Rechnungen hinzufügen';
    ...
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="leistungen">Abgerechnete Leistungen</Label>
            <Select
          ...
          <div className="space-y-2">
            ...
            <Input
              id="zahlungsdatum"
              type="date"
              value={fields.zahlungsdatum ?? ''}
              onChange={e => setFields(f => ({ ...f, zahlungsdatum: e.target.value }))}
            />
          </div>
          <div className="space-y-2">
