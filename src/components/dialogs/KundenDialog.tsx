...
export function KundenDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false, enablePhotoLocation = true }: KundenDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'kunden');
  ...
  const DIALOG_INTENT = defaultValues ? 'Kunden bearbeiten' : 'Kunden hinzufügen';
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="organisation">Organisation / Firma</Label>
            <Input
              id="organisation"
          ...
          <div className="space-y-2">
            <Label htmlFor="ansprechperson_vorname">Vorname Ansprechpartner</Label>
            <Input
              id="ansprechperson_vorname"
              value={fields.ansprechperson_vorname ?? ''}
              onChange={e => setFields(f => ({ ...f, ansprechperson_vorname: e.target.value }))}
            />
          </div>
          <div className="space-y-2">
            <Label htmlFor="ansprechperson_nachname">Nachname Ansprechpartner</Label>
            <Input
              id="ansprechperson_nachname"
              value={fields.ansprechperson_nachname ?? ''}
              onChange={e => setFields(f => ({ ...f, ansprechperson_nachname: e.target.value }))}
            />
          </div>
          <div className="space-y-2">
