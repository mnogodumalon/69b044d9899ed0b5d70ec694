  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Kunden anzeigen</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Organisation / Firma</Label>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm">{record.fields.ansprechperson_vorname ?? '—'}</p>
          </div>
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Nachname Ansprechpartner</Label>
            <p className="text-sm">{record.fields.ansprechperson_nachname ?? '—'}</p>
          </div>
          <div className="space-y-1">
