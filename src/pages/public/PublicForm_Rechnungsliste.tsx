...
const PROXY_BASE = '';
const APP_ID = '69b044a21918feff3a9b0843';
...
export default function PublicFormRechnungsliste() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Rechnungsliste — Formular</h1>
        </div>
